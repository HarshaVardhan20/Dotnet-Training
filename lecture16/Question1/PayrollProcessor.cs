...
namespace Question1
{
    ...
    public class PayrollProcessor
    {
        ...
        {
            processor.AddEmployee(new FullTimeEmployee(1, "Amit", "amit@corp.com", "IT", 50000, 5000));
            processor.AddEmployee(new FullTimeEmployee(2, "Neha", "neha@corp.com", "HR", 60000, 6000));
            processor.AddEmployee(new ContractEmployee(3, "Rahul", "rahul@corp.com", "Ops", 400, 20));
            processor.AddEmployee(new ContractEmployee(4, "Sneha", "sneha@corp.com", "Ops", 450, 22));
        }
